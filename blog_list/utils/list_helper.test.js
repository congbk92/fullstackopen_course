...
describe('total likes', () => {
    ...
    test('when list has not any blog, equals to 0', () => {
    ...
    test('when list has many blogs, equals the sum likes of those', () => {
        const result = listHelper.totalLikes(listWithNBlog)
...
describe('the most favourite blog', () => {
    ...
    test('when list has not any blog, the most favourite empty', () => {
